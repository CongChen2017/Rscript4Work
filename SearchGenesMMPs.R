# The purpose of this script is to search certain gene list from an RNA-seq data set.
# after find matched gene symbols, take out the data accordingly and generate a new CSV file.

#load library
library(org.Mm.eg.db)

#set work path to source file folder
setwd("C:/MMPs in SPC ATII cells/")
# setwd("Desktop")
...
genelist <- read.csv("MMPsGeneID.csv", stringsAsFactors = FALSE)
...
# the method listed below to generate a new df based on overlaped genes is not necessary.
